# Eaglercraft2 Community Features
...
## Users Directory
- Visit `/users` to view all registered users.
- User cards show **Online** and **Offline** tags.
- Click a user card to open their public profile page.
